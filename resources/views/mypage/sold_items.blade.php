    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-10 offset-1 bg-white">
                ...
                <div class="font-weight-bold text-center border-bottom pb-3 pt-3" style="font-size: 24px">募集した投稿</div>
                        ...
                        <div class="flex-fill p-3">
                            <div>
                                @if ($item->isStateSelling)
                                    <span class="badge badge-success px-2 py-2">募集中</span>
                                @else
                                    <span class="badge badge-dark px-2 py-2">締め切り済み</span>
                                @endif
                            ...
                            <div>
                                ...
                                <span>{{$item->created_at->format('Y年n月j日 H:i')}}</span><!-- formatメソッドで書式を指定して文字列に変換 -->
                            </div>
                        </div>
